...
1). Mastercoins, 2). Ether, 3). Counterparty, 4). SWARM, 5). NXT, 6). Rivetz, 7). SAFE Coins, 8). DEPRA, 9). Storj, 10). LTBCOIN, 11). API Coins, 12). Ripple XRP, 13). Permacredits
